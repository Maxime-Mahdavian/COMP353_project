...
<div style=' margin-left: 180px;'>
    ...
    while($temp = mysqli_fetch_array($result)){
        echo "<div  style='background-color: white; margin-left:40px; border: solid; border-radius: 7px; width:50%;'>";
            ...
            echo "<table style='width: 100%'><tr><td><h1 style='margin-left:5px; font-weight: bold'>" . $temp['title']."</h1></td>";
            ...
            echo "<table style='width: 61%; margin-left: 20px;'><col style='width: 40%;'><tr><td style='border-radius: 5px; margin-left: 20px; border: solid;'><p style='margin-left: 5px;' align='top-left'>" . $temp['body'] . "</p></td></tr>";
            ...
            echo "<form style='left-margin:300px;' action='../comment_page.php' method='post' id='commentForm'>";
            echo "<input type='hidden' name='postid' value='". $temp['postID']."' />";
            echo "<input style='left-margin:300px;' class='ui blue button' type='submit' name='comment' value='Comment'/>";
            echo "</form>";
            echo "<hr>";
        echo "</div><br>";
    }
